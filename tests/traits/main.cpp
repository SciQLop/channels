...
TEST_CASE("Channels utils", "[type traits]")
{
  ...
  //  REQUIRE(
  //      is_channel_like_v<decltype(test_functor_t::static_source >> test_functor_t::static_filter >> test_functor_t::static_sink)>);
    REQUIRE(
    ...
    REQUIRE(are_compatible_v<decltype(test_functor_t::static_source), decltype(test_functor_t::static_filter)>);
    REQUIRE(are_compatible_v<decltype(test_functor_t::static_source), decltype(test_functor_t::static_sink)>);
    REQUIRE(are_compatible_v<decltype(test_functor_t::static_filter), decltype(test_functor_t::static_sink)>);
